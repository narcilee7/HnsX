// Package domain defines the Harness-first DomainSpec v2 and its sub-types.
// It remains backward-compatible with v1 specs via loader upgrade logic.
package domain
...
type DomainSpec struct {
	...
	// Deprecated: legacy v1 workflow kept for compatibility.
	Workflow *WorkflowSpec `json:"workflow,omitempty" yaml:"workflow,omitempty"`
	// Deprecated: legacy v1 agents kept for compatibility.
	LegacyAgents []AgentSpec `json:"agents,omitempty" yaml:"agents,omitempty"`
}
...
type HarnessSpec struct {
	...
	OutputSchemas map[string]json.RawMessage  `json:"output_schemas,omitempty" yaml:"output_schemas,omitempty"`
...
type AgentSpec struct {
	...
	Adapter      json.RawMessage `json:"adapter,omitempty" yaml:"adapter,omitempty"`
...
type SessionSpec struct {
	...
	TriggerSchema json.RawMessage `json:"trigger_schema,omitempty" yaml:"trigger_schema,omitempty"`
	OutputSchema  string          `json:"output_schema,omitempty" yaml:"output_schema,omitempty"`
	Workflow      *WorkflowSpec   `json:"workflow,omitempty" yaml:"workflow,omitempty"`
}

// WorkflowSpec is the legacy deterministic DAG.
...
// StepSpec is a legacy workflow step.
