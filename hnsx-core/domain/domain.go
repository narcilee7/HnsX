...
//
// Field types use `any` for free-form configuration so YAML maps/lists/scalars
// round-trip natively through yaml.v3 + encoding/json. Strong typing is added
// where the schema is fixed (e.g. AdapterConfig).
package domain
